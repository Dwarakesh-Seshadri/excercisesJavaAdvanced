...
public class Person {
	...
	public boolean equals(Object o) {
        ...
        return Objects.equals(firstName, person.firstName) && Objects.equals(lastName, person.lastName) && Objects.equals(birthDate, person.birthDate) && Objects.equals(email, person.email) && Objects.equals(languageCode, person.languageCode);
	}

	@Override
	public int hashCode() {
		return Objects.hash(firstName, lastName, birthDate, email, languageCode);
	}
	...
	public String toString() {
		return "Person " + personNumber + ": " + this.firstName + " " + this.lastName + " is " + this.calculateAge()
						 + " years old." ;
	}
